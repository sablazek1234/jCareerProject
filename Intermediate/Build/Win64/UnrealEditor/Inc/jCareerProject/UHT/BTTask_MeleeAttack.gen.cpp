...
#include "jCareerProject/BTTask_MeleeAttack.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeBTTask_MeleeAttack() {}
// Cross Module References
	AIMODULE_API UClass* Z_Construct_UClass_UBTTask_BlackboardBase();
	JCAREERPROJECT_API UClass* Z_Construct_UClass_UBTTask_MeleeAttack();
	JCAREERPROJECT_API UClass* Z_Construct_UClass_UBTTask_MeleeAttack_NoRegister();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBTTask_MeleeAttack_Statics::Class_MetaDataParams[] = {
		...
		{ "Comment", "/**\n * \n */" },
#endif
		{ "IncludePath", "BTTask_MeleeAttack.h" },
		{ "ModuleRelativePath", "BTTask_MeleeAttack.h" },
	};
#endif
	...
	template<> JCAREERPROJECT_API UClass* StaticClass<UBTTask_MeleeAttack>()
	{
		return UBTTask_MeleeAttack::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UBTTask_MeleeAttack);
	UBTTask_MeleeAttack::~UBTTask_MeleeAttack() {}
	struct Z_CompiledInDeferFile_FID_Users_Dustin_Documents_Unreal_Projects_jCareerProject_Source_jCareerProject_BTTask_MeleeAttack_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Dustin_Documents_Unreal_Projects_jCareerProject_Source_jCareerProject_BTTask_MeleeAttack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBTTask_MeleeAttack, UBTTask_MeleeAttack::StaticClass, TEXT("UBTTask_MeleeAttack"), &Z_Registration_Info_UClass_UBTTask_MeleeAttack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTTask_MeleeAttack), 2331231525U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Dustin_Documents_Unreal_Projects_jCareerProject_Source_jCareerProject_BTTask_MeleeAttack_h_2821455250(TEXT("/Script/jCareerProject"),
		Z_CompiledInDeferFile_FID_Users_Dustin_Documents_Unreal_Projects_jCareerProject_Source_jCareerProject_BTTask_MeleeAttack_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Dustin_Documents_Unreal_Projects_jCareerProject_Source_jCareerProject_BTTask_MeleeAttack_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
